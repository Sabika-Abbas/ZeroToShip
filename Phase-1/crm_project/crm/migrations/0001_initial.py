# Generated by Django 6.0.7 on 2026-07-23 22:21
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('coffee', 'Coffee Chat'), ('hackathon', 'Hackathon'), ('email', 'Email'), ('career_fair', 'Career Fair'), ('lecture', 'Guest Lecture'), ('other', 'Other')], default='other', max_length=20)),
